          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <div class="button navbar-right">
                 ...
                 <a class="navbar-btn nav-button wow bounceInRight login" data-wow-delay="0.8s" href="<?php echo base_url('/home/Registrarse'); ?>">Registrarse</a>
              </div>
              <ul class="main-nav nav navbar-nav navbar-right">
                ...
                <li class="wow fadeInDown" data-wow-delay="0.2s"><a href="<?php echo base_url('/Home/Servicios'); ?>">Servicios</a></li>
